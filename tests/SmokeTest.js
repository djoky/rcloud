casper.test.begin("Automation Smoke Test", 25, function suite(test) {
    ...
    casper.then(function () {
        ...
        this.wait(2000);
        this.sendKeys('div.settings-input:nth-child(4) > label:nth-child(1) > input:nth-child(2)', 'rcloud.viewer, rcloud.enviewer');
        this.then(function () {
            this.click('#command-prompt > div:nth-child(3) > div:nth-child(1)');
            //this.capture('./Images/before_enable_extensions.png')
        });
        ...
        //this.capture('./Images/after_enable_extensions.png')
    });
    ...
    casper.then(function () {
        ...
        // this.capture('./Images/cell_outputs.png')
    });
    ...
    casper.then(function () {
        ...
        this.wait(2000);
        //this.capture('./Images/workspace.png')
    ...
    casper.then(function () {
        ...
        this.waitForSelector('body > form:nth-child(1)', function () {
            ...
            //this.capture('./Images/Notebook.R_login.png')
        }, function () {
            this.echo("Notebook.R Page could not be loaded")
            //this.capture('./Images/Notebook.R_login_timeout.png')
        }, 60000);
    });
    ...
    casper.then(function () {
        ...
        this.waitForSelector('#chartdiv0', function () {
            ...
            //this.capture('./Images/mini_login.png')
        }, function () {
            this.echo("Mini.html page could not be loaded")
            //this.capture('./Images/mini_login_timeout.png')
        }, 60000);
    });
    ...
    casper.viewport(1024, 768).then(function () {
        ...
        this.waitForSelector('.r-result-div', function () {
            ...
            //this.capture('./Images/view_login.png')
        }, function () {
            this.echo("View.html page could not be loaded")
            //this.capture('./Images/view_login_timeout.png')
        }, 60000);
    });
    ...
    casper.then(function () {
        ...
        this.then(function () {
            if (this.visible('.modal-body')) {
                ...
                this.then(function () {
                    //this.capture('./Images/open_in_github.png')
        ...
        this.waitForSelector({type: 'css', path: '#open_in_github'}, function () {
            ...
            if (this.click({type: 'css', path: '#open_in_github'})) {
                ...
                this.viewport(1366, 768).withPopup(/gist.github.com/, function () {
                    ...
                    //this.capture('./Images/github.png')
                });
            }
            else {
